    ...
    with open(input_filename, 'r', encoding="utf-8") as csvfile:
        ...
        for row in reader:
            ...
            if found_by_zip and found_by_zip[0]:
                ...
                if found_by_dc:
                    found_by_city_name = [obj for obj in found_by_dc if obj.get('Stadt, Region, Landkreis (LK)') == row['city']]
...
_snowload_data = "googleSheetData/Snow load zones 2023-02-07 - NI (03) .csv"
